...
#define Z_MAX_POS 350 // The gantry can go up to 400mm but the bowden tube starts hitting the top bar around 350mm
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_CENTER - 27)  // X point for Z homing when homing all axes (G28).
