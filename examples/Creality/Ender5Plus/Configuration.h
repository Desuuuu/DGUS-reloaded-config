...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_CENTER - 41)  // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (Y_CENTER - 8)  // Y point for Z homing when homing all axes (G28).
#endif
